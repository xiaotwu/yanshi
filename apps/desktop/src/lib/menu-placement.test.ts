...
// Geometry from the original regression case:
...
describe("placeAnchoredMenu", () => {
  it("flips the overflowing menu upward and keeps it inside the 818px viewport", () => {
...
describe("placeSubmenu", () => {
  ...
  it("shifts the overflowing submenu up so its box stays inside the viewport", () => {
